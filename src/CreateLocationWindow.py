...
class CreateLocationWindow(QDialog):
	...
	def __init__(self, mainw, parent=None):
		...
		layout.addRow(QLabel("Minimum age (Ma):"), self.mina)
		layout.addRow(QLabel("Maximum age (Ma):"), self.maxa)
		layout.addRow(QLabel("Minimum bathymetry (m):"), self.minb)
		layout.addRow(QLabel("Maximum bathymetry (m):"), self.maxb)
		layout.addRow(QLabel("Altitude (m):"), self.alt)
